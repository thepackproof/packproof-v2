...
- Existing token-free CI compiles both Android Kotlin modules and builds a debug APK. A debug APK is not a signed release AAB. Final-source native status is recorded separately in the PR.
