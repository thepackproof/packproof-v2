...
Packing Station Mode is a client workflow over those commands. Merchant finalization requires qualifying fulfillment capture decided by the server; see [PACKING_STATION.md](PACKING_STATION.md).
