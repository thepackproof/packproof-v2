...
export function Brand({ dark = false }: { dark?: boolean }) {
  return <a className={`pp-brand ${dark ? "on-dark" : ""}`} href="/" aria-label="PackProof home"><img src="/brand/packproof-symbol.svg" alt="" width="38" height="38" /><span className="pp-brand-lettering" aria-hidden="true">Pack<span>Proof</span></span></a>;
}
