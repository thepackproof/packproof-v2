...
export function StudyConsentCard(){
  ...
  const [deviceClass,setDeviceClass]=useState<'s24_ultra'|'a16_5g'|'other_android'|'ios'>(Platform.OS==='ios'?'ios':'other_android');
